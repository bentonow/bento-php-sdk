...
final class BentoFormsTest extends TestCase
{
  ...
  public function testGetFormResponsesWorksWithTheFormID()
  {
        ...
        'attributes' => [
          ...
          'data' => [
            ...
            'fields' => [
              ...
              'question1' => 'item1',
              'question2' => ['item3'],
              'question3' => 'This is to test the response\n\nOf this form.\n\nFor testing.',
              'question4' => '3',
              'question5' => 'item2',
              'question6' => '',
              'first_name' => 'Test',
    ...
    $result = $bento->V1->Forms->getResponses('test-formid-1234');

    $requests = Server::received();

    $this->assertEquals(
      'id=test-formid-1234&site_uuid=test',
